...
Pour le cas multi-classes on fait l'hypothèse que :
$$
...
- Cifar100 : 60000 images, 100 classes : dauphin, requin, tulippes, chaise, loup, crocodile,...

::: {layout-ncol=1 layout="[[40,-20,80], [150]]"}
![](cif10.png){width=300}
![](cif100.jpg){width=300}
:::
...
- L'erreur de classification vaut 32%.
...
- L'erreur de classification vaut 28%.
...
- L'erreur de classification vaut 7,9%.
