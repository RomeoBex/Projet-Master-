...
::: {layout-ncol=2}
![Modèle non calibré](Figure_1.svg){width=250 #fig-1 fig-pos='H'}

![Modèle calibré avec TS](Figure_2.svg){width=250 #fig-2 fig-pos='H'}
:::
![Modèle calibré avec TEC](Figure_3.svg){width=250 #fig-3 fig-pos='H'}


En comparant @fig-1 avec @fig-2 et @fig-3 on remarque que c'est bien le cas.
