...
\end{align*}
```
le terme entre crochet peut être vu comme la moyenne d'une quantité au carré et peut être ainsi décomposée comme la somme du carré de la quantité moyenne plus la variance de la quantité. 
