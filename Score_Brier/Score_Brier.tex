...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, breakable, borderline west={3pt}{0pt}{shadecolor}, sharp corners, boxrule=0pt, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
...
plus mauvais score sera de 1. Code de la fonction :
...
\KeywordTok{def}\NormalTok{ brier\_score\_f(y\_true, y\_prob):}
    \CommentTok{\# Args:}
    \CommentTok{\# {-} y\_true : les vraies étiquettes }
    \CommentTok{\# {-} y\_prob : les probabilités prédites pour la classe positive }
\NormalTok{    n }\OperatorTok{=} \BuiltInTok{len}\NormalTok{(y\_true)}
    
\NormalTok{    brier\_score }\OperatorTok{=}\NormalTok{ np.}\BuiltInTok{sum}\NormalTok{((y\_prob }\OperatorTok{{-}}\NormalTok{ y\_true) }\OperatorTok{**} \DecValTok{2}\NormalTok{) }\OperatorTok{/}\NormalTok{ n}
 
    \ControlFlowTok{return}\NormalTok{ brier\_score}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Exemple de prédictions et de vraies étiquettes}
\NormalTok{y\_true }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{])}
\NormalTok{y\_prob }\OperatorTok{=}\NormalTok{ np.array([}\FloatTok{0.1}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\FloatTok{0.8}\NormalTok{, }\FloatTok{0.3}\NormalTok{])}


\NormalTok{n }\OperatorTok{=} \BuiltInTok{len}\NormalTok{(y\_true)}

\CommentTok{\# Calcul du score de Brier}
\NormalTok{brier\_score }\OperatorTok{=}\NormalTok{ brier\_score\_f(y\_true, y\_prob)}

\BuiltInTok{print}\NormalTok{(}\StringTok{"Score de Brier:"}\NormalTok{, brier\_score)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Score de Brier: 0.03749999999999999
\end{verbatim}
